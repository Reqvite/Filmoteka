 ...
 * limitations under the License.
 */
$r("firebase","9.13.0","app");var af;af=new URL(o("kyEFX").resolve("4CESq"),import.meta.url).toString();const lf=e=>{let n=null;const i=e.reduce(((e,i)=>{let{id:r,poster_path:o,title:s,release_date:a,vote_average:l,genres:c}=i;o=o?`https://www.themoviedb.org/t/p/w500/${o}`:t(Rn),l=l?l.toFixed(1):"?",l>=7?n="masterpiece":l>=5&&l<=7?n="good":l<=5&&(n="bad");let u=c.map((e=>e.name));u.length>=3&&(u=[u[0],u[1],"Other"]);const h=a.split("-");return e+`<li class="collection__item" data-id=${r}>\n        <a href="" class="card-wrap__link link">\n              <div class="card">\n              <div class="card__image-wrap">\n                      <img class="card__image" src="${o}" alt="${s}" width="395px" height="574px">\n                       </div>\n                  <div class="card__wrap">\n                      <h2 class="card__title">${s}</h2>\n                      <div class="card__data">\n                          <p class="card__genre">${u.join(", ")} |</p>\n                          <p class="card__year">${h[0]}</p>\n                          <p class="card-film__rating">${l}</p>\n                      </div>\n                  </div>\n              </div>\n              </a>\n          </li>\n               `}),"");return En.gallery.innerHTML=i},cf=()=>{const e=`\n  <img\n  src="${af}"\n  alt="foto"\n  width="300px" height="300px"\n/>\n  `;En.gallery.innerHTML=e},uf=document.querySelector(".home-js"),hf=document.querySelector(".my-library-js"),df=document.querySelector(".header__section"),ff=document.querySelector(".header__search-form"),pf=document.querySelector(".header__mylibrary"),mf=document.querySelector(".toggle-theme");function gf(e){e.preventDefault(),cf(),Dn(),df.classList.remove("header__section--mylibrary"),pf.style.display="none",df.classList.add("header__section"),ff.style.display="block",mf.classList.replace("toggle-theme-mylibrary","toggle-theme")}uf.addEventListener("click",gf),hf.addEventListener("click",(function(e){e.preventDefault(),df.classList.remove("header__section"),ff.style.display="none",pf.style.display="flex",df.classList.add("header__section--mylibrary"),mf.classList.replace("toggle-theme","toggle-theme-mylibrary")})),uf.addEventListener("click",gf);const yf=nf(jr({apiKey:"AIzaSyAmrcw3LWh5vdrPE40gh2Uggxq3EG96Lys",authDomain:"film-library-registration.firebaseapp.com",databaseURL:"https://film-library-registration-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"film-library-registration",storageBucket:"film-library-registration.appspot.com",messagingSenderId:"394290136676",appId:"1:394290136676:web:9848416d6de87eb2614171"})),vf=ja(),bf=(vf.currentUser,new Date),_f=document.querySelector(".signin-Btn"),wf=document.querySelector(".login-Btn"),xf=document.querySelector(".login-Out"),kf=document.querySelector(".submit-signUp-btn"),Cf=document.querySelector(".submit-login-btn"),If=document.querySelector(".backdrop-form"),Ef=document.querySelector(".modal-form-btn"),Nf=document.querySelector(".name-input"),Tf=document.querySelector(".registr"),Sf=document.querySelector(".form-title"),Rf=document.querySelector(".my-library-js");function Lf(){If.classList.add("form-hidden"),Tf.removeEventListener("submit",Pf),Tf.removeEventListener("submit",Df),kf.style.display="none",Cf.style.display="none",document.removeEventListener("keydown",Af),If.removeEventListener("click",Of),En.body.style.overflow="scroll"}function Af(e){"Escape"===e.code&&Lf()}function Of(e){e.target.classList.contains("backdrop-form")&&Lf()}function Pf(e){e.preventDefault();const t=Tf.elements[0].value,n=Tf.elements[1].value,i=Tf.elements[2].value;If.classList.add("form-hidden"),Ms(vf,n,i).then((e=>{const i=e.user;Kd(Vd(yf,"users/"+i.uid),{username:t,queueList:"",watchedList:"",email:n,last_login:bf}),Mf(),Ff(),sf.Notify.success("Congratulations, your account has been successfully created.",{timeout:1e3})})).catch((e=>{e.code;const t=e.message;Ff(),sf.Notify.failure(t,{timeout:1e3})})),e.target.reset()}function Df(e){e.preventDefault();Tf.elements[0].value;const t=Tf.elements[1].value,n=Tf.elements[2].value;localStorage.setItem("userId",""),Fs(vf,t,n).then((e=>{const t=e.user,n=t.uid;localStorage.setItem("userId",n),Gd(Vd(yf,"users/"+t.uid),{last_login:bf}),Mf(),Ff();Yd(Xd(Vd(nf()),`users/${n}`)).then((e=>{e.exists()?sf.Notify.success(`Hi, ${e.val().username||"Anonymus"}, you are logged in successfully.`,{timeout:1e3}):console.log("No data available")})).catch((e=>{Ff(),console.error(e)}))})).catch((e=>{e.code;const t=e.message;Tf.removeEventListener("submit",Pf),sf.Notify.failure(t,{timeout:1e3})}))}function Mf(){If.classList.add("form-hidden"),_f.style.display="none",wf.style.display="none",xf.style.display="block",Rf.style.display="block",Cf.style.display="none",localStorage.setItem("userIsLogin","true"),En.body.style.overflow="scroll"}function Ff(){Tf.removeEventListener("submit",Pf),Tf.removeEventListener("submit",Df)}Rf.style.display="none",xf.style.display="none",function(){const e=localStorage.getItem("userIsLogin");JSON.parse(e)&&(_f.style.display="none",wf.style.display="none",Rf.style.display="block",xf.style.display="block")}(),Ef.addEventListener("click",Lf),_f.addEventListener("click",(e=>{If.classList.remove("form-hidden"),Nf.style.display="block",Tf.addEventListener("submit",Pf),kf.style.display="block",Sf.textContent="SIGN IN TO FILMOTEKA",En.body.style.overflow="hidden",document.addEventListener("keydown",Af),If.addEventListener("click",Of)})),wf.addEventListener("click",(e=>{Tf.addEventListener("submit",Df),Sf.textContent="LOG IN TO FILMOTEKA",If.classList.remove("form-hidden"),Nf.style.display="none",kf.style.display="none",Cf.style.display="block",En.body.style.overflow="hidden",document.addEventListener("keydown",Af),If.addEventListener("click",Of)})),xf.addEventListener("click",(e=>{var t;(t=vf,rr(t).signOut()).then((()=>{_f.style.display="block",wf.style.display="block",xf.style.display="none",Rf.style.display="none",localStorage.setItem("userId",""),localStorage.setItem("userIsLogin","false"),gf(e),Dn(),sf.Notify.success("Successful logged out.",{timeout:1e3})})).catch((e=>{e.code;const t=e.message;sf.Notify.failure(t,{timeout:1e3})}))}));const Uf=document.querySelector(".section-main"),zf=document.querySelector(".error-img");document.addEventListener("click",(function(){navigator.onLine||(Uf.outerHTML='<p class="error-title">Check your connection and please reload the page.<p>',zf.style.display="block")}));const Bf=ja();let qf;const Wf=document.querySelector(".container-films"),jf=document.querySelector(".backdrop-details"),Hf=document.querySelector(".modal-icon-cross"),$f=document.querySelector("body");document.querySelector(".trailer-button"),document.querySelector(".trailer");Wf.addEventListener("click",(e=>{var t;(null===(t=e.target.getAttribute("class"))||void 0===t?void 0:t.includes("test-modal"))&&(jf.classList.remove("is-hidden"),Hf.addEventListener("click",(e=>{jf.classList.add("is-hidden")})))})),Us(Bf,(e=>{qf=null==e?void 0:e.uid}));Wf.addEventListener("click",(async e=>{var t;if(e.preventDefault(),null===(t=e.target.closest(".collection__item"))||void 0===t?void 0:t.dataset.id){const t=await si(e.target.closest(".collection__item").dataset.id);void 0===qf?hp(t):np(t)}}));const Vf=e=>{document.querySelector(".film-details-wrapper");jf.classList.add("hidden"),Hf.removeEventListener("click",Vf),document.removeEventListener("keydown",Kf),jf.removeEventListener("click",Gf),$f.style.overflow="scroll"};function Xf(){const e=document.querySelectorAll(".details-list_title");JSON.parse(localStorage.getItem("theme"))&&e.forEach((e=>e.style.color="#ffffff"))}function Kf(e){"Escape"===e.code&&Vf()}function Gf(e){e.target.classList.contains("backdrop-details")&&Vf()}const Yf=ja();let Jf;const Qf=Vd(nf());Us(Yf,(e=>{Jf=null==e?void 0:e.uid}));const Zf=(e,n)=>{const i=document.querySelector(".queue-add");i.textContent="REMOVE FROME QUEUE",i.classList.add("remove-from-queue"),i.classList.remove("queue-add"),Vf();const r=e.id;JSON.parse(localStorage.getItem("userIsLogin"))?Yd(Xd(Qf,`users/${Jf}`)).then((n=>{if(n.exists()){const i=n.val().queueList;if(""===i){t(Qn).Notify.success("Added movie to QUEUE",{timeout:2e3});let n=[];n.push(e);const i=JSON.stringify(n);Gd(Vd(yf,"users/"+Jf),{queueList:i})}else{const n=JSON.parse(i);if(n.some((e=>e.id===r)))t(Qn).Notify.info("Тhis movie is in the QUEUE",{timeout:2e3});else{n.push(e);const i=JSON.stringify(n);Gd(Vd(yf,"users/"+Jf),{queueList:i}),t(Qn).Notify.success("Added movie to QUEUE",{timeout:2e3})}}}else t(Qn).Notify.failure("No data available",{timeout:2e3}),console.log("No data available")})).catch((e=>{console.error(e)})):t(Qn).Notify.failure("Please log in",{timeout:2e3})},ep=(e,n)=>{const i=e.id,r=document.querySelector(".remove-from-queue");r.textContent="ADD TO QUEUE",r.classList.add("queue-add"),r.classList.remove("remove-from-queue"),Vf(),Yd(Xd(Qf,`users/${Jf}`)).then((e=>{if(e.exists()){const n=JSON.parse(e.val().queueList).filter(((e,t,n)=>e.id!==i&&n.push(e)));if(0===n.length&&"true"!==tp.dataset.active)return cf(),Vf(),void Gd(Vd(yf,"users/"+Jf),{queueList:""});"true"!==tp.dataset.active&&(lf(n),Vf());const r=JSON.stringify(n);Gd(Vd(yf,"users/"+Jf),{queueList:r}),t(Qn).Notify.success("removed movie from QUEUE",{timeout:2e3})}else console.log("No data available")})).catch((e=>{console.error(e)}))},tp=document.querySelector(".home-js");En.headerNavList.addEventListener("click",(e=>{if("library"===e.target.name&&(tp.setAttribute("data-active",!1),En.gallery.innerHTML="",Nn()),"library"!==e.target.name)return En.listEl.classList.remove("is-hidden"),void tp.setAttribute("data-active",!0);console.log(tp.dataset.active),En.listEl.classList.add("is-hidden"),En.watchedBtnInLibrary.classList.remove("header__mylibrary-btn--active"),En.queueBtnInLibrary.classList.add("header__mylibrary-btn--active"),"true"!==tp.dataset.active&&Yd(Xd(Qf,`users/${Jf}`)).then((e=>{if(e.exists()){if(""===e.val().queueList)cf(),t(Qn).Notify.failure("Opps🙊 your library is empty!",{timeout:2e3});else{const t=JSON.parse(e.val().queueList);lf(t)}}else console.log("No data available");Nn()})).catch((e=>{console.error(e)}))}));En.queueBtnInLibrary.addEventListener("click",(e=>{En.watchedBtnInLibrary.classList.remove("header__mylibrary-btn--active"),En.queueBtnInLibrary.classList.add("header__mylibrary-btn--active"),En.gallery.innerHTML="",Nn(),Yd(Xd(Qf,`users/${Jf}`)).then((e=>{if(e.exists()){if(""===e.val().queueList)cf(),t(Qn).Notify.failure("Opps🙊 your library is empty!",{timeout:2e3});else{const t=JSON.parse(e.val().queueList);console.log(t),lf(t),console.log(t)}}else console.log("No data available");Nn()})).catch((e=>{console.error(e)})),En.queueBtnInLibrary.classList.contains("header__mylibrary-btn--active")}));const np=async e=>{const t=e.data.id;Yd(Xd(Qf,`users/${Jf}`)).then((n=>{if(n.exists()){const i=n.val().queueList,r=(i&&JSON.parse(i)||[]).some((e=>e.id===t));up(e,r)}else console.log("No data available")})).catch((e=>{console.error(e)}))},ip=Vd(nf());let rp;const op=ja();op.currentUser;Us(op,(e=>{rp=null==e?void 0:e.uid}));const sp=(e,n)=>{let i=JSON.parse(localStorage.getItem("userIsLogin"));const r=e.id;let o=[];i?Yd(Xd(ip,`users/${rp}`)).then((n=>{if(n.exists()){const i=n.val().watchedList;if(""===i){t(Qn).Notify.success("Added movie to watched list."),o.push(e);const n=JSON.stringify(o);Gd(Vd(yf,"users/"+rp),{watchedList:n})}else{const n=JSON.parse(i);if(n.some((e=>e.id===r)))t(Qn).Notify.info("This movie is in the watched list.");else{n.push(e);const i=JSON.stringify(n);Gd(Vd(yf,"users/"+rp),{watchedList:i}),t(Qn).Notify.success("Added movie to watched list.")}}}else console.log("No data available")})).catch((e=>{console.error(e)})):t(Qn).Notify.failure("Please log in")};En.watchedBtnInLibrary.addEventListener("click",(e=>{En.queueBtnInLibrary.classList.remove("header__mylibrary-btn--active"),En.watchedBtnInLibrary.classList.add("header__mylibrary-btn--active"),En.gallery.innerHTML="",Nn(),Yd(Xd(ip,`users/${rp}`)).then((e=>{if(e.exists()){if(""===e.val().watchedList)cf(),t(Qn).Notify.failure("Opps🙊 your watched list is empty!");else{const t=JSON.parse(e.val().watchedList);lf(t)}}else console.log("No data available");Nn()})).catch((e=>{console.error(e)})),En.watchedBtnInLibrary.classList.contains("header__mylibrary-btn--active")}));const ap=document.querySelector(".film-modal-content"),lp=document.querySelector(".backdrop-details"),cp=document.querySelector(".modal-icon-cross"),up=(e,n)=>{let{poster_path:i,original_title:r,vote_average:o,vote_count:s,popularity:a,genres:l,overview:c,id:u}=e.data,h=null;i=i?`https://www.themoviedb.org/t/p/w500/${i}`:t(Rn),o=o?o.toFixed(1):"?";const d=n?"REMOVE FROM QUEUE":"ADD TO QUEUE",f=n?"remove-from-queue":"queue-add";o>=7?h="masterpiece":o>=5&&o<=7?h="good":o<=5&&(h="bad");const p=`<div class="film-details-wrapper">\n\t<div>\n\t\t<div class="thumb">\n\t\t\t<img class="modal-img" src="${i}" alt="${r}" data-id="${u}" />\n\t\t\t<button class="trailer-button trailer-button--view button" type="button">\n\t\t\t\t<span class="trailer-button__text trailer-button__text--play"></span>\n\t\t\t</button>\n\t\t</div>\n\t</div>\n\t<div class="film-details">\n\t\t<h2 class="film-details__main-title">${r}</h2>\n\t\t<ul class="details-list list">\n\t\t\t<li class="details-list__item">\n\t\t\t\t<p class="details-list_title">Vote / Votes</p>\n\t\t\t\t<span class="details-list__information-1 ${h}">${o}</span>&nbsp/&nbsp<span\n\t\t\t\t\tclass="details-list__information-2">${s}</span>\n\t\t\t</li>\n\t\t\t<li class="details-list__item">\n\t\t\t\t<p class="details-list_title">Popularity</p>\n\t\t\t\t<span class="details-list__information-2">${a}</span>\n\t\t\t</li>\n\t\t\t<li class="details-list__item">\n\t\t\t\t<p class="details-list_title">Original Title</p>\n\t\t\t\t<span class="details-list__information-2 ">${r}</span>\n\t\t\t</li>\n\t\t\t<li class="details-list__item">\n\t\t\t\t<p class="details-list_title">Genre</p>\n\t\t\t\t<span class="details-list__information-2">${l.map((e=>e.name))}</span>\n\t\t\t</li>\n\t\t</ul>\n\t\t<h3 class="film-details__secondary-title">About</h3>\n\t\t<p class="film-details__about">${c}</p>\n\t\t<ul class="buttons-list list">\n\t\t\t<li class="buttons-list__item">\n\t\t\t\t<button class="main-button watched-add button" type="button" name="watched">Add to watched</button>\n\t\t\t</li>\n\t\t\t<li class="buttons-list__item"><button class="secondary-button ${f} button" type="button" name="queue">${d}</button></li>\n\t\t</ul>\n\t\t<div class="trailer"></div>\n\t\t<button class="trailer-button trailer-button--close button is-hidden" type="button">\n\t\t\t\t<span class="trailer-button__text trailer-button__text--stop"></span>\n\t\t\t</button>\n\t</div>\n</div>`;ap.insertAdjacentHTML("beforeend",p),dp();const m=document.querySelector(".queue-add"),g=document.querySelector(".remove-from-queue");null==m||m.addEventListener("click",(t=>Zf(e.data))),null==g||g.addEventListener("click",(t=>ep(e.data))),li(u);document.querySelector(".watched-add").addEventListener("click",(t=>sp(e.data)))},hp=e=>{let{poster_path:n,original_title:i,vote_average:r,vote_count:o,popularity:s,genres:a,overview:l,id:c}=e.data,u=null;n=n?`https://www.themoviedb.org/t/p/w500/${n}`:t(Rn),r=r?r.toFixed(1):"?",r>=7?u="masterpiece":r>=5&&r<=7?u="good":r<=5&&(u="bad");const h=`<div class="film-details-wrapper">\n\t  <div>\n\t\t  <div class="thumb">\n\t\t\t  <img class="modal-img" src="${n}" alt="${i}" data-id="${c}" />\n\t\t\t  <button class="trailer-button trailer-button--view button" type="button">\n\t\t\t\t  <span class="trailer-button__text trailer-button__text--play"></span>\n\t\t\t  </button>\n\t\t  </div>\n\t  </div>\n\t  <div class="film-details">\n\t\t  <h2 class="film-details__main-title">${i}</h2>\n\t\t  <ul class="details-list list">\n\t\t\t  <li class="details-list__item">\n\t\t\t\t  <p class="details-list_title">Vote / Votes</p>\n\t\t\t\t  <span class="details-list__information-1 ${u}">${r}</span>&nbsp/&nbsp<span\n\t\t\t\t\t  class="details-list__information-2">${o}</span>\n\t\t\t  </li>\n\t\t\t  <li class="details-list__item">\n\t\t\t\t  <p class="details-list_title">Popularity</p>\n\t\t\t\t  <span class="details-list__information-2">${s}</span>\n\t\t\t  </li>\n\t\t\t  <li class="details-list__item">\n\t\t\t\t  <p class="details-list_title">Original Title</p>\n\t\t\t\t  <span class="details-list__information-2 ">${i}</span>\n\t\t\t  </li>\n\t\t\t  <li class="details-list__item">\n\t\t\t\t  <p class="details-list_title">Genre</p>\n\t\t\t\t  <span class="details-list__information-2">${a.map((e=>e.name))}</span>\n\t\t\t  </li>\n\t\t  </ul>\n\t\t  <h3 class="film-details__secondary-title">About</h3>\n\t\t  <p class="film-details__about">${l}</p>\n\t\t  <ul class="buttons-list list">\n\t\t\t  <li class="buttons-list__item">\n\t\t\t\t  <button class="main-button watched-add button" type="button" name="watched">Add to watched</button>\n\t\t\t  </li>\n\t\t\t  <li class="buttons-list__item"><button class="secondary-button queue-add button" type="button" name="queue">Add to queue</button></li>\n\t\t  </ul>\n\t\t  <div class="trailer"></div>\n\t\t  <button class="trailer-button trailer-button--close button is-hidden" type="button">\n\t\t\t\t  <span class="trailer-button__text trailer-button__text--stop"></span>\n\t\t\t  </button>\n\t  </div>\n  </div>`;ap.insertAdjacentHTML("beforeend",h),dp();const d=document.querySelector(".queue-add");null==d||d.addEventListener("click",(e=>t(Qn).Notify.failure("please log in"))),li(c);document.querySelector(".watched-add").addEventListener("click",(e=>t(Qn).Notify.failure("please log in")))};function dp(){const e=document.querySelectorAll(".film-details-wrapper"),t=document.querySelector(".film-details-wrapper");(null==e?void 0:e.length)>=2&&(null==t||t.remove());const n=document.querySelector("body");lp.classList.remove("hidden"),n.style.overflow="hidden",cp.addEventListener("click",Vf),document.addEventListener("keydown",Kf),lp.addEventListener("click",Gf),Xf();const i=document.querySelectorAll(".details-list_title");JSON.parse(localStorage.getItem("theme"))&&i.forEach((e=>e.style.color="#ffffff"))}function fp(){if(JSON.parse(localStorage.getItem("theme")))return En.footer.style.backgroundColor="rgb(182, 165, 165)",document.body.classList.add("dark-theme"),En.modal_bgr.classList.add("dark"),En.toggleTheme.style.backgroundColor="#000",En.iconSun.classList.add("is-hiden"),En.iconBrightness.classList.remove("is-hiden"),void En.modalFooter.classList.add("dark");document.body.classList.remove("dark-theme"),En.footer.style.backgroundColor="#ffffff",En.modal_bgr.classList.remove("dark"),En.toggleTheme.style.backgroundColor="#fff",En.iconBrightness.classList.add("is-hiden"),En.iconSun.classList.remove("is-hiden"),En.modalFooter.classList.remove("dark")}fp(),En.toggleTheme.addEventListener("click",(function(){document.body.classList.toggle("dark-theme");const e=JSON.stringify(document.body.classList.contains("dark-theme"));localStorage.setItem("theme",e),fp()})),window.addEventListener("scroll",(()=>{const e=window.scrollY||document.documentElement.scrollTop;let t=0;t=window.innerWidth<=768?4e3:2e3,e>t?En.btnUp.classList.remove("is-hiden"):En.btnUp.classList.add("is-hiden")})),En.btnUp.addEventListener("click",(function(){window.scrollTo({top:0,left:0,behavior:"smooth"})}));
//# sourceMappingURL=index.da2c60a1.js.map
